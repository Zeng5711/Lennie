...
public class SmoothImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
            ...
            if(mTransformStart){
                Logger.d( "mTransfrom.startScale:"+mTransfrom.startScale);
                Logger.d( "mTransfrom.startScale:"+mTransfrom.endScale);
                Logger.d( "mTransfrom.scale:"+mTransfrom.scale);
                Logger.d( "mTransfrom.startRect:"+mTransfrom.startRect.toString());
                Logger.d( "mTransfrom.endRect:"+mTransfrom.endRect.toString());
                Logger.d("mTransfrom.rect:"+mTransfrom.rect.toString());
            }
