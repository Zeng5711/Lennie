...
public class ImageItemLinearLayout extends LinearLayout {

    private int mLeft, mRight, mTop, mBottom;
    private Hashtable map = new Hashtable();

    public ImageItemLinearLayout(Context context) {
        super(context);
    }

    public ImageItemLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ImageItemLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
