...
import com.hxyd.dyt.widget.dragphotoview.DragPhotoView;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinlayout = (LinearLayout) findViewById(R.id.viewpager_ll);
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            ...
            ImageloadTools.load(getApplicationContext(), mList.get(i), mPhotoViews[i]);
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.points_norma);
            ImageView imageView = new ImageView(this);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(bitmap.getWidth(), bitmap.getHeight());
            layoutParams.setMargins(0, 0, 10, 0);
            imageView.setLayoutParams(layoutParams);
            imageView.setImageResource(R.mipmap.points_norma);
            mLinlayout.addView(imageView);
        }

        if (mPhotoViews.length == 1) {
            mLinlayout.setVisibility(View.GONE);
        }
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (mPreSelectedIm != null) {
                    mPreSelectedIm.setImageResource(R.mipmap.points_norma);
                }

                ImageView im = (ImageView) mLinlayout.getChildAt(position);
                im.setImageResource(R.mipmap.points_selected);
                mPreSelectedIm = im;
